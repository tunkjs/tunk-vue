...
module.exports = Vue;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36), __webpack_require__(58)))
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\vue-state\\examples\\test\\vue-flow-promise-middleware.js'\n    at Error (native)");
			...
			Vue.flow.model = function (name, opts) {
				...
				function run_middlewares(model, args, context, dispatch) {
					...
					function next(args) {
						...
						if (index < middlewares.length) return middlewares[index++](dispatch, next, end, context).apply(model, args);else return end(args[0]);
					}
					function end(result) {
						if (!result) return;
						...
						for (var x in this.$options.action) {
							if (this.$options.action.hasOwnProperty(x)) {
								...
								this[x] = function (modelName, actionName) {
									return function () {
										if (arguments[0] && arguments[0].cancelBubble !== undefined && arguments[0].srcElement) models[modelName][actionName].call(models[modelName]);else models[modelName][actionName].call(models[modelName], Array.prototype.slice.call(arguments));
									};
								}(action[0], action[1]);
							}
						}
...
var compons = __webpack_require__(67);
...
_vue2.default.flow.bind('beforeStore', function (newState, oldState) {
	console.log('test:beforeStore', JSON.parse((0, _stringify2.default)({ newState: newState, oldState: oldState })));
}); // <template>
...
exports.default = {
	...
	options: __webpack_require__(135),
...
var _vueFlow = __webpack_require__(60);

var _vueFlow2 = _interopRequireDefault(_vueFlow);

var _vueFlowPromiseMiddleware = __webpack_require__(59);

var _vueFlowPromiseMiddleware2 = _interopRequireDefault(_vueFlowPromiseMiddleware);

var _vueFlowFunctionMiddleware = __webpack_require__(140);
...
_vue2.default.flow.addMiddleware([_vueFlowFunctionMiddleware2.default, _vueFlowPromiseMiddleware2.default]);
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\vue-state\\examples\\test\\vue-flow-function-middleware.js'\n    at Error (native)");
